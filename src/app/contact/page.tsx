...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-white/[0.06] last:border-b-0">
      ...
      {open && (
        <p className="pb-5 text-[15px] leading-[1.7] text-slate-400">{a}</p>
      )}
    </div>
  );
}
      ...
      <div className="relative z-[2]">
        ...
        <div className="mx-auto max-w-[1140px] px-6 py-20">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-5 max-w-[480px] text-[17px] leading-[1.6] text-slate-400">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1.4fr]">
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-[#0D0E16] p-7">
                ...
                <p className="text-[15px] leading-[1.6] text-slate-400">
                  We respond to all inquiries <strong className="text-slate-300">within 24 hours</strong> on business days (Mon–Fri, 09:00–17:00 CET).
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-[#0D0E16] p-7">
                ...
                <p className="text-[15px] leading-[1.6] text-slate-400">
                  ...
                  W. Dreesweg 14<br />
                  1314CL Almere<br />
                  <span className="text-[13px] text-slate-500">Netherlands</span>
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-[#0D0E16] p-8 md:p-10">
              ...
              >
                ...
                <p className="text-center text-[12px] text-slate-500">We respond within 24 hours on business days.</p>
              </form>
            </div>
          </div>
          ...
          <div className="mt-20">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-[480px] text-[16px] leading-[1.6] text-slate-400">
                Quick answers to the questions we hear most often.
              </p>
            </div>
            <div className="mx-auto max-w-[760px] rounded-2xl border border-white/[0.06] bg-[#0D0E16] px-8 py-2">
              {FAQS.map((faq) => (
