            ...
            {PLAN_OPTIONS.map((p) => (
              <div key={p.id} className="flex flex-col rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-5">
                ...
                <button
                  ...
                  disabled={loading !== null}
                  className="mt-5 inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#2F5D3A] px-6 text-[14px] font-semibold text-white transition-colors hover:bg-[#24492D] disabled:opacity-50"
                >
